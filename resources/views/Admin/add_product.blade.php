        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ url('/insert-product') }}" enctype="multipart/form-data" style="background-image: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%);">
                        @csrf
                            <div class="form-row">
                                <div class="col-md-6">
                            ...
                            <div class="form-group mt-4 mb-0"><button class="btn btn-primary btn-block" style="background-image: linear-gradient(to right, #6a11cb 0%, #2575fc 100%);">Submit</button></div>
                        </form>
                    </div>
                </div>
            </div>
