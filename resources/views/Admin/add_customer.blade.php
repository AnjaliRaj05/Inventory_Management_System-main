                ...
                <div class="card shadow-lg border-0 rounded-lg mt-5" >
                    ...
                    <div class="card-body">
                        ...
                        @csrf
                            ...
                            <div class="form-group mt-4 mb-0"><button class="btn btn-primary btn-block" style="background-image: linear-gradient(to right, #4facfe 0%, #00f2fe 100%);">Submit</button></div>
                        </form>
                    </div>
                </div>
            </div>
