...
<html lang="en">
    ...
    <body class="sb-nav-fixed" style="background-image: linear-gradient(to top, #fbc2eb 0%, #a6c1ee 100%);">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark" style = "background-image: linear-gradient(to bottom, #323232 0%, #3F3F3F 40%, #1C1C1C 150%), linear-gradient(to top, rgba(255,255,255,0.40) 0%, rgba(0,0,0,0.25) 200%)";
 background-blend-mode: multiply;>  
            <a class="navbar-brand">Product Managment System</a>
        ...
        <div id="layoutSidenav">
            <div id="layoutSidenav_nav" >
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" style = "background-image: linear-gradient(to bottom, #323232 0%, #3F3F3F 40%, #1C1C1C 150%), linear-gradient(to top, rgba(255,255,255,0.40) 0%, rgba(0,0,0,0.25) 200%)">
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Anjali Raj</div>
                            <div>
